...
public class Sound {
	...
	public Sound() {
		...
		soundURL[10] = getClass().getResource("/sound/darkflame.wav");
		soundURL[11] = getClass().getResource("/sound/cuttree.wav");
		soundURL[12] = getClass().getResource("/sound/pause.wav");
		soundURL[13] = getClass().getResource("/sound/gameover.wav");
		soundURL[14] = getClass().getResource("/sound/dooropen.wav");
	}
